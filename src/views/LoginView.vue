        ...
        <div class="pt-18 lg:pt-20 pb-4">
            <div class="px-container-mobile md:px-container-desktop">
                <div class="mx-auto w-full text-plantea-white-smoke-500 text-center p-4 lg:max-w-[440px]">
                    ...
                    <h1 class="font-serif font-thin text-center text-4xl mb-2 lg:text-5xl lg:mb-3">Sign In</h1>
                    ...
                    <p><button @click="signInWithGoogle" class="p-1">
                        ...
                        <button @click="signInWithFacebook" class="p-1">
                            <img class="w-10 aspect-square"
                                src="../assets/img/facebook-signin-assets/facebook_2x.png" alt="Google Sign In"
                                aria-label="Facebook Logo for Sign In">
                        </button>
                    </p>
                    <p class="font-serif subpixel-antialiased">Don't have an account? <button @click="register"
                            class="font-serif subpixel-antialiased underline underline-offset-4 decoration-dotted">Register</button>
                    </p>
...
const signInWithGoogle = () => {
    ...
    return signInWithPopup(firebaseAuth, provider).then(() => router.push('/account').catch(e => { }))
}
